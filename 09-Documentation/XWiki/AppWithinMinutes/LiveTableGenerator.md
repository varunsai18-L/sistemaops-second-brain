---
id: xwiki-xwiki:AppWithinMinutes.LiveTableGenerator
type: XWiki Page
space: "AppWithinMinutes"
author: "XWiki.superadmin"
version: "1.1"
last_modified: 1781906709000
sync_date: 2026-07-21 11:02:19
tags:
  - xwiki/documentation
  - space/appwithinminutes
---
...
- **Space:** AppWithinMinutes
- **Author:** XWiki.superadmin
- **Last Modified:** 1781906709000
- **Source:** [LiveTableGenerator](https://wiki.systemaops.in/bin/view/AppWithinMinutes/xwiki:AppWithinMinutes.LiveTableGenerator)
...
#macro(prepareColumnProperties)
  ...
  #set ($htmlFieldTypes = ['TextArea', 'Users', 'Groups', 'Page'])
  #foreach ($column in $columns)
    #set ($field = $xclass.get($column))
      ...
      #set ($discard = $columns.set($mathtool.sub($foreach.count, 1), $column))
    #end
    #if ($field)
      #set ($properties = {})
...
#set($shortName = $classDoc.documentReference.name.replaceAll("Class", "").toLowerCase())
...
${escapetool.h}set (${escapetool.d}columns = [#foreach($column in $columns)#if($foreach.count > 1), #end'#escapeSingleQuotes($column)'#end])
