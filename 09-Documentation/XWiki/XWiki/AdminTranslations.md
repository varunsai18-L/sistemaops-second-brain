---
id: xwiki-xwiki:XWiki.AdminTranslations
type: XWiki Page
space: "XWiki"
author: "XWiki.superadmin"
version: "1.1"
last_modified: 1781905890000
sync_date: 2026-07-21 11:01:23
tags:
  - xwiki/documentation
  - space/xwiki
---
...
- **Space:** XWiki
- **Author:** XWiki.superadmin
- **Last Modified:** 1781905890000
- **Source:** [AdminTranslations](https://wiki.systemaops.in/bin/view/XWiki/xwiki:XWiki.AdminTranslations)

---

administration.title=Administration
administration.title.page=Page Administration
administration.title.wiki=Wiki Administration
administration.title.global=Global Administration
administration.sectionTitle=Administration: {0}
...
admin.colorthemes.local=Local
admin.colorthemes.global=Global
...
XWiki.XWikiPreferences_meta.hint=Specifies the metadata that is included in the HTML header of each page, including the page description, author, and keywords. The default meta.vm template is used when the meta field is blank. Use #template('meta.vm') as part of the field content to benefit from future enhancements to the default meta definition.
...
# Export Section
administration.section.export.pages=Pages
...
administration.section.export.description.hint=The package description, displayed when importing the package.
administration.section.export.author.hint=The package author, displayed when importing the package.
...
# Groups section
administration.section.groups.deleteUserFromGroup.loading=Removing member from group
administration.section.groups.deleteUserFromGroup.success=Member successfully removed from group
administration.section.groups.deleteUserFromGroup.failure=Failed to remove member from group

# Other Category
admin.other=Other
admin.other.description=Various configurations for extensions.
administration.section.analytics.status=Status
administration.section.analytics.status.hint=Determine if the tracking in Google Analytics™ is active or not

# Social category
admin.social=Social
admin.social.description=Configuration for social features.

# Configurable Class
XWiki.ConfigurableClass_displayInSection=Display in section
XWiki.ConfigurableClass_heading=Heading
...
XWiki.ConfigurableClass_scope=Scope
XWiki.ConfigurableClass_scope_WIKI=Wiki
