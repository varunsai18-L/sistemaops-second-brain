---
id: xwiki-xwiki:XWiki.LiveTableResultsMacros
type: XWiki Page
space: "XWiki"
author: "XWiki.superadmin"
version: "1.1"
last_modified: 1781905332000
sync_date: 2026-07-21 11:00:34
tags:
  - xwiki/documentation
  - space/xwiki
---
...
- **Space:** XWiki
- **Author:** XWiki.superadmin
- **Last Modified:** 1781905332000
- **Source:** [Livetable Results Macros](https://wiki.systemaops.in/bin/view/XWiki/xwiki:XWiki.LiveTableResultsMacros)
...
#macro(livetable_getTableName $colname)
  #livetable_getPropertyClassAndType($colname)
    ...
    ## The following logic is mirrored from ListClass and might need to be updated when the logic in ListClass changes.
    ...
    #set($largeStorage = $propClass.get($colname).getProperty('largeStorage').getValue())
    #if($multiSelect == 1)
